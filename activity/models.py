...
class ActivityBase(TimeStampAbstractMixin):
    ...
    data_input = models.ForeignKey("ActivityBase", null=True, on_delete=models.CASCADE)
...
class Cards(TimeStampAbstractMixin):
    ...
    activity_created_by = models.ForeignKey(ActivityBase, on_delete=models.CASCADE)
...
class PrioritizedCards(TimeStampAbstractMixin):
    ...
    prioritization_activity = models.ForeignKey(ActivityBase, on_delete=models.CASCADE)
...
class Buckets(TimeStampAbstractMixin):
    ...
    bucketing_activity = models.ForeignKey(ActivityBase, on_delete=models.CASCADE)
    created_by = models.ForeignKey(GenericUser, default=None, on_delete=models.CASCADE)
