...
class Command(BaseCommand):
    ...
    def generate_default_buckets(self):
        ...
        bucketing_activities = ActivityBase.objects.filter(component__activity_type='bucketing').values_list('id', flat=True)
        for bucketing_activity, bucketing_name in zip(bucketing_activities, bucketing_names):
